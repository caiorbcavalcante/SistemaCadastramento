...
serviceRouter.get("/service/user/:id_service", serviceController.getServiceByUser)
serviceRouter.get("/service/barber/:id_service", serviceController.getServiceByBarber)
